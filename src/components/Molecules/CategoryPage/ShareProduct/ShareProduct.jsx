                        ...
                        <S.MobileSocial>
                            <S.MobileSocialIcon>
                                <svg width="12" height="23" viewBox="0 0 12 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <path d="M3.48398 12.295V22.2857H8.12929V12.295H11.2266L11.8455 8.45296H8.12929V5.76365C8.12929 4.687 8.51602 3.84205 10.2197 3.84205H12V0.306626C10.9943 0.153313 9.90961 0 8.9039 0C5.72883 0 3.48398 1.92045 3.48398 5.37863V8.45296H0V12.295H3.48398Z" fill="#191919"/>
                                </svg>
                            </S.MobileSocialIcon>
                        ...
                        <S.MobileSocial>
                            <S.MobileSocialIcon>
                                <svg width="20" height="17" viewBox="0 0 20 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M20 1.92375C19.2562 2.25 18.4638 2.46625 17.6375 2.57125C18.4875 2.06375 19.1362 1.26625 19.4412 0.305C18.6488 0.7775 17.7737 1.11125 16.8412 1.2975C16.0887 0.49625 15.0162 0 13.8462 0C11.5762 0 9.74875 1.8425 9.74875 4.10125C9.74875 4.42625 9.77625 4.73875 9.84375 5.03625C6.435 4.87 3.41875 3.23625 1.3925 0.7475C1.03875 1.36125 0.83125 2.06375 0.83125 2.82C0.83125 4.24 1.5625 5.49875 2.6525 6.2275C1.99375 6.215 1.3475 6.02375 0.8 5.7225C0.8 5.735 0.8 5.75125 0.8 5.7675C0.8 7.76 2.22125 9.415 4.085 9.79625C3.75125 9.8875 3.3875 9.93125 3.01 9.93125C2.7475 9.93125 2.4825 9.91625 2.23375 9.86125C2.765 11.485 4.2725 12.6788 6.065 12.7175C4.67 13.8088 2.89875 14.4663 0.98125 14.4663C0.645 14.4663 0.3225 14.4513 0 14.41C1.81625 15.5813 3.96875 16.25 6.29 16.25C13.835 16.25 17.96 10 17.96 4.5825C17.96 4.40125 17.9538 4.22625 17.945 4.0525C18.7588 3.475 19.4425 2.75375 20 1.92375Z" fill="#191919"/>
                                </svg>
                            </S.MobileSocialIcon>
                        ...
                        <S.MobileSocial>
                            <S.MobileSocialIcon>
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8 0H17C21.1415 0 24.5 3.3585 24.5 7.5V16.5C24.5 20.6415 21.1415 24 17 24H8C3.8585 24 0.5 20.6415 0.5 16.5V7.5C0.5 3.3585 3.8585 0 8 0ZM17 21.75C19.895 21.75 22.25 19.395 22.25 16.5V7.5C22.25 4.605 19.895 2.25 17 2.25H8C5.105 2.25 2.75 4.605 2.75 7.5V16.5C2.75 19.395 5.105 21.75 8 21.75H17Z" fill="#191919"/>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M6.5 12C6.5 8.6865 9.1865 6 12.5 6C15.8135 6 18.5 8.6865 18.5 12C18.5 15.3135 15.8135 18 12.5 18C9.1865 18 6.5 15.3135 6.5 12ZM8.75 12C8.75 14.067 10.433 15.75 12.5 15.75C14.567 15.75 16.25 14.067 16.25 12C16.25 9.9315 14.567 8.25 12.5 8.25C10.433 8.25 8.75 9.9315 8.75 12Z" fill="#191919"/>
                                    ...
                                    <S.SocialIcon>
                                        ...
                                        >
                                            ...
                                            <path
                                                ...
                                                fill="#191919"
                                            />
                                            <circle cx="12.3006" cy="3.69999" r="0.533" fill="#191919"/>
                                        </svg>
                                    </S.SocialIcon>
